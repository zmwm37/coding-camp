...
It's important to look at the timeframe of measurements to see if they are consistent within and across beaches. Most beaches have near-daily readings from around Memorial Day to Labor Day. Humboldt is the big exception, which starts later and ends earlier with measurements. However, looking at the measurement dates for Humboldt across all beaches yields similar results: Humboldt water is gross!
...
And for kicks, I wanted to see if the relationship between different beaches' water quality. 
