...
``` {r libraries & data, echo = F, results = F, message = F, warning = F}
...
## Graph
```{r visualize data, warning = F, error = F}
...
It's important to look at the timeframe of measurements to see if they are consistent within and across beaches.
